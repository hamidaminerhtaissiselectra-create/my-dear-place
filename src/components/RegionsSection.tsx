              ...
              >
                <Link to={r.link} className="flex flex-col h-full">
                  <div className="relative h-48 w-full overflow-hidden rounded-t-2xl shadow-md">
                    <img src={r.image} alt={`Réparation et installation de volets roulants en ${r.name} — Répar'Action Volets intervient dans les départements ${r.depts}`} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" width={400} height={300} />
