...
const additionalRegions = [
  { 
    ...
    color: "bg-service-orange/5 border-service-orange/20",
    image: "/images/zones/hauts-de-france.webp",
  ...
  { 
    ...
    color: "bg-service-violet/5 border-service-violet/20",
    image: "/images/zones/grand-est.webp",
  ...
  { 
    ...
    color: "bg-service-rose/5 border-service-rose/20",
    image: "/images/zones/normandie.webp",
  ...
  { 
    ...
    image: "/images/zones/bretagne.webp",
  ...
  { 
    ...
    color: "bg-service-blue/5 border-service-blue/20",
    image: "/images/zones/pays-de-la-loire.webp",
  ...
  { 
    ...
    color: "bg-service-emerald/5 border-service-emerald/20",
    image: "/images/zones/centre-val-de-loire.webp",
  ...
  { 
    ...
    color: "bg-service-orange/5 border-service-orange/20",
    image: "/images/zones/bourgogne-franche-comte.webp",
  ...
  { 
    ...
    color: "bg-service-violet/5 border-service-violet/20",
    image: "/images/zones/nouvelle-aquitaine.webp",
  ...
  { 
    ...
    color: "bg-service-rose/5 border-service-rose/20",
    image: "/images/zones/occitanie.webp",
  ...
  { 
    ...
    color: "bg-service-cyan/5 border-service-cyan/20",
    image: "/images/zones/auvergne-rhone-alpes.webp",
